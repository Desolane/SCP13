...
/datum/reagent/amnestics/machoman/on_mob_life(mob/living/M) // make sure to blacklist this from 294
	to_chat(M, "<span class='notice'>TIME TO KILL STUFF</span>")
	...
	M.visible_message("<span class='warning'>[M] suddenly becomes more energetic, the desire of wrestling fills their eyes. <b><i>Run</b></i></span>")
	playsound(src,'sound/misc/nymphchirp.ogg',3,3)
	holder.remove_reagent(/datum/reagent/amnestics/classe, volume)