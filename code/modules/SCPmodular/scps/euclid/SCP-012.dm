...
/obj/item/paper/scp012
	name = "SCP-012"
	icon = 'code/modules/SCPmodular/spcicon/scpmobs/scp012.dmi'
	iconliving
	desc = "You really shouldntve looked at this. <b> The desire to complete it fills your senses.</b>"
...
/obj/item/paper/proc/can_affect(var/mob/living/carbon/human/H)
	return H.stat == CONSCIOUS && !H.blinded && !istype(H.glasses, /obj/item/clothing/glasses/sunglasses/blindfold)
